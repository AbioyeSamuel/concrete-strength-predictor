...
# Plot correlation heatmap with larger annotation font size
plt.figure(figsize=(8, 6))
heatmap = sns.heatmap(corr_matrix, annot=True, cmap='viridis', fmt=".2f", annot_kws={"size": 15})  # Adjust the size parameter to increase font size

# Increase font size of x-axis labels (column names)
plt.xticks(fontsize=15)

# Increase font size of y-axis labels (row names)
